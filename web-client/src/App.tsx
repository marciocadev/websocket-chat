...
const URL = 'wss://bbpi851oua.execute-api.us-east-1.amazonaws.com/dev/';
...
function App() {
  ...
  const onSocketOpen = useCallback(() => {
    ...
    // socket.current?.send(JSON.stringify({ action: 'setname', message: name }));
    // setMembers([name as never, ...members])
  }, []);
